    ...
    if check_type == 'snaplex':
      ...
      for _, project_value in snaplogic_projects:
        ...
        for project in project_value["cc_info"]["running"]:
          ...
          stats_metrics = ["active_threads", "active_pipelines", "alive_since", "leased_slots", "mem_used", "cpu_user", "max_file_descriptors", "cpu_util", "cc_mem_total", "mem_used_absolute", "disk_free", "disk_total"]
          stats_metric_kv = {}
